...
/**
 * Esta clase tiene la función de mostrar y poder añadir al carrito todos los Tablets disponibles.
 * 
 * @author Javier
 * @version 1
 * 
...
@SuppressLint("NewApi")
public class Tablets extends Activity implements OnItemSelectedListener{
	...
	static String tipoTablet;
	static String tabletCategoria = "Tablet";
	@SuppressLint("NewApi")
	@Override
	public void onCreate(Bundle savedInstanceState) {
	    ...
	    tablet = (Spinner) findViewById(R.id.spinnerTablets);
	    lista = (ListView) findViewById(R.id.listViewTablets);
	    
	    ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
		        R.array.tablets, android.R.layout.simple_spinner_item);
	    adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
	    tablet.setAdapter(adapter);		
	    tablet.setOnItemSelectedListener(this);
	...
	public static void solicitaLista() {
		cProducto= new CrudProductos();
		l = cProducto.findByTipo(tabletCategoria, tipoTablet);
	}
	/**
